...
<div class="page-header"><h1>Tampilkan Laporan</h1></div>
<div class="row">
    <div class="col-xs-12">
    	<?php
		...
		?>
    	<form target="_blank" action="<?=base_url("Laporan/cetak_laporan")?>" method="get" enctype="multipart/form-data" id="formku">   
		    ...
		    <div class="form-group col-sm-3">
				<select name="jenis" class="form-control required">
					...
					<option value="1">Registrasi Pelanggan</option>
	...
	<div class="col-xs-12">
		<?php
			...
			// 						</div>
			// 					<a href="'.base_url("Booking/read/".ec($r->id_booking)).'" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i> Detail Booking</a>
			// 					</div>
			// 				</div>
			// 			</div>
			// 		</div>
