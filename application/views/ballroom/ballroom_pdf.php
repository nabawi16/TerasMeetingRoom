...
$isi=' <h2>Ballroom List</h2>
    ...
    foreach ($ballroom_data as $ballroom){
    $isi .='<tr>
				<td>'.++$start.'</td>
				<td>'.$ballroom->nama_ballroom .'</td>
				<td>'.$ballroom->kapasitas .'</td>
				<td>'.$ballroom->status .'</td>	
            </tr>';
    }
$isi .='</table>';
...
$pdf->Output('Cetak_Ballroom.pdf', 'I');
